...
/**
 * Объекты — масонри-сетка с hover-зумом (ТЗ §6, блок 14).
 *
 ...
 * заводов.
 *
 * Заголовок «Примеры работ» / «Наши объекты» не ставим: из архива не следует, что
 * монтаж делали мы, а приписывать себе чужую работу — то же заявление о
 * несуществующем, что и выдуманный отзыв. Если объекты наши — заголовок меняем.
 */
      ...
      <div className="mx-auto max-w-7xl px-5 py-20 sm:py-28">
        <Reveal>
          ...
          <p className="mt-4 max-w-2xl text-stone">
            Крыльца, уличные лестницы и террасы, выложенные клинкером Paradyz. У каждого
            кадра — коллекция, по которой можно найти материал в каталоге.
          </p>
        </Reveal>
